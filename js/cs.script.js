    ...
    function addToCartSuccess (jqXHR, textStatus, errorThrown){
        ...
        $.ajax({
            ...
            success: function (cart){
                ...
                if(jqXHR['image'] == null){
                    var src = "//hstatic.net/0/0/global/noDefaultImage6_large.gif";
                }
                ...
                + '<div class="product-new-price"><span>' + Haravan.formatMoney(jqXHR["price"], "{{amount}}â‚«") + '</span></div></div></div>'
                + '</div>'
                + '</div>'
                ...
                + '<div class="total_price"><span>Tá»•ng tiá»n: </span> <span class="">' + Haravan.formatMoney(cart.total_price, "{{amount}}") +'Ä‘</span></div>'
